  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.grey.withValues(alpha: 0.1), // Sửa withOpacity thành withValues
            blurRadius: 10,
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  height: 50,
                  decoration: BoxDecoration(
                    color: Colors.green.withValues(alpha: 0.1), // Sửa withOpacity thành withValues
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: _getStatusColor().withValues(alpha: 0.1), // Sửa withOpacity thành withValues
