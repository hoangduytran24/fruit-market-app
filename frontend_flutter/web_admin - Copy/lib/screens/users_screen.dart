...
class _UsersScreenState extends State<UsersScreen> {
  ...
  // --- DIALOG THÊM ADMIN (ĐÃ CẬP NHẬT HIỂN THỊ LỖI DƯỚI FIELD) ---
  ...
  void _showAddAdminDialog() {
    ...
    // Biến để hứng lỗi từ Server trả về cho từng field
    String? serverEmailError;
    String? serverPhoneError;
                    ...
                    children: [
                      ...
                      _buildDialogCard([
                        ...
                        _buildPopupField(
                          ...
                          // Xử lý lỗi từ server: Nếu có lỗi server, hiển thị nó, nếu người dùng gõ lại thì xóa lỗi
                          errorText: serverEmailError,
                          onChanged: (v) => setDialogState(() => serverEmailError = null),
                          validator: (v) {
                        ...
                        _buildPopupField(
                          ...
                          errorText: serverPhoneError,
                          onChanged: (v) => setDialogState(() => serverPhoneError = null),
                          validator: (v) {
                                ...
                                if (formKey.currentState!.validate()) {
                                  try {
                                    ...
                                    if (success && mounted) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: const Text("Thành công"), backgroundColor: primaryGreen)
                                      );
                                    }
                                  } catch (e) {
                                    ...
                                    setDialogState(() {
                                      if (errorMsg.contains("email")) {
                                        serverEmailError = "Email này đã được sử dụng";
                                      } else if (errorMsg.contains("phone") || errorMsg.contains("số điện thoại")) {
                                        serverPhoneError = "Số điện thoại này đã được sử dụng";
                                      } else {
                                        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildPopupField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorText: errorText, // Hiển thị lỗi đỏ như yêu cầu
        filled: true,
